...
function gamePlay() {
    ...
    var ballInterval = setInterval(function () {
        ...
        if (ballPosition.x <= player1XPosition + 20 && ballPosition.x >= player1XPosition) {
            if (ballPosition.y >= player1State.y && ballPosition.y <= player1State.y + 50) {
                isMoveLeft = false
                isMoveRight = true
                isMoveUp = true
                isMoveDown = false
            }
            if (ballPosition.y >= player1State.y + 50 && ballPosition.y <= player1State.y + 100) {
                isMoveLeft = false
                isMoveRight = true
                isMoveDown = true
                isMoveUp = false
        ...
        if (ballPosition.x >= player2XPosition - 20 && ballPosition.x <= player2XPosition) {
            if (ballPosition.y >= player2State.y && ballPosition.y <= player2State.y + 50) {
                isMoveLeft = true
                isMoveRight = false
                isMoveUp = true
                isMoveDown = false
            }
            if (ballPosition.y >= player2State.y + 50 && ballPosition.y <= player2State.y + 100) {
                isMoveLeft = true
                isMoveRight = false
                isMoveDown = true
                isMoveUp = false
